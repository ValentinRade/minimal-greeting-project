...
import { Settings, Home, Contact, Database, FileText, ClipboardList, Truck } from 'lucide-react';
import {
  Sidebar,
  SidebarContent,
  SidebarHeader,
...
const ShipperSidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { 
      icon: Truck, 
      label: 'Spot-Ladungen', 
      path: '/dashboard/shipper/spot-loads' 
    },
    { 
      icon: FileText, 
    ...
    },
    {
      icon: ClipboardList,
      label: 'Präferenzen',
      path: '/dashboard/shipper/preferences'
    },
    { 
      icon: Settings, 
