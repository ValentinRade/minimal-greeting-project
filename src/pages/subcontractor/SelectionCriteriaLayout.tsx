    ...
    <AppLayout>
      <div className="flex flex-col lg:flex-row w-full">
        <Card className="lg:w-64 mb-6 lg:mb-0 lg:mr-6 shrink-0">
          <CardHeader>
            <CardTitle>{t('selection.title', 'Auswahlkriterien')}</CardTitle>
            <CardDescription>{t('selection.description', 'Verwalten Sie Ihre Auswahlkriterien')}</CardDescription>
          </CardHeader>
          <CardContent className="p-0">
            <nav className="flex flex-col gap-1 px-2 pb-4">
              <div className="px-3 pt-4 pb-1">
                <h3 className="text-xs font-medium text-muted-foreground">{t('selection.categories', 'Kategorien')}</h3>
              </div>
              <NavLink 
              ...
              >
                ...
                <span>{t('selection.prequalifications', 'Präqualifikationen')}</span>
              </NavLink>
              <NavLink 
              ...
              >
                ...
                <span>{t('selection.ranking', 'Ranking')}</span>
              </NavLink>
            </nav>
          </CardContent>
        </Card>
